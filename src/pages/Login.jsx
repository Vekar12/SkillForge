...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 24px', background: '#000' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: 360 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.4)', margin: 0 }}>Build real skills. One day at a time.</p>
        </div>
        <div style={{ borderRadius: 24, padding: 32, background: '#161616', border: '1px solid rgba(255,255,255,0.07)' }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, margin: '0 0 6px', letterSpacing: '-0.3px' }}>Welcome back</h2>
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.4)', margin: '0 0 32px' }}>Sign in to continue your learning</p>
          {hasClientId ? (
            ...
            <>
              ...
              <p style={{ textAlign: 'center', fontSize: 12, color: 'rgba(255,255,255,0.2)', marginTop: 14 }}>Demo mode — set VITE_GOOGLE_CLIENT_ID to enable real sign-in</p>
            </>
          )}
        </div>
      </div>
