    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: '#000' }}>
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="rounded-3xl p-8" style={{ background: '#1C1C1E', border: '1px solid rgba(255,255,255,0.07)' }}>
          ...
          {hasClientId ? (
            /* Real Google Sign-In — credential is the Google ID token */
            ...
            /* Demo mode — no client ID configured, use a mock button */
            <button
          ...
          {!hasClientId && (
            <p className="text-center text-xs mt-4" style={{ color: 'rgba(255,255,255,0.25)' }}>
              Demo mode — set VITE_GOOGLE_CLIENT_ID to enable real sign-in
            </p>
          )}
        </div>
      </div>
